...
private final XboxController xboxController = new XboxController(0);
  ...
  */
  private RobotContainer() {
    ...
    SmartDashboard.putData("ToggleDrive", new ToggleDrive( m_drivetrain ));
...
// Create some buttons
final JoystickButton bumperLeft_ToggleDrive = new JoystickButton(xboxController, XboxController.Button.kBumperLeft.value);        
bumperLeft_ToggleDrive.whenPressed(new ToggleDrive( m_drivetrain ) ,true);
    SmartDashboard.putData("BumperLeft_ToggleDrive",new ToggleDrive( m_drivetrain ) );
